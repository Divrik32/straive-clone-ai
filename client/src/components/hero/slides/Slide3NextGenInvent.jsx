    ...
    <section className="relative w-full h-full overflow-hidden bg-white">
      ...
      <div className="relative section-container h-full flex flex-col items-center justify-center text-center gap-6">
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 text-2xl font-bold text-[#1a1a2e]">
          ...
          <div className="flex items-center gap-2 text-xl font-bold text-[#0a1a3a]">
            <Brain className="w-6 h-6 text-cyan-500" />
            AI
          </div>
        </div>

        <h1 className="text-3xl md:text-5xl font-extrabold text-[#0a1a3a]">
          AI Innovation Hub
        </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-lg md:text-xl text-[#5a5a6a]">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-3xl md:text-5xl font-extrabold text-brand-orange">
            Real Business
          </p>
        </div>
