        ...
        <div className="relative bg-[#f7f7f9] rounded-2xl px-6 py-14 overflow-hidden">
          ...
          <div className="text-center max-w-lg mx-auto mb-8">
            ...
            <p className="text-sm text-[#4a4a5a] leading-relaxed">
              We believe great technology is created by curious people who
              collaborate, learn, and continuously explore new possibilities.
              Our work culture encourages innovation, knowledge sharing, and
              professional growth.
            </p>
          </div>
